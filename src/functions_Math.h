...
/*
// Math functions and Vector/Matrix Calculations
//
// In TNT,
...
//
//  PutRowVectorInMatrix, GetRowVectorInMatrix, 
//  PutMatrixInArray3D, GetMatrixInArray3D
*/
...
/** This function returns the inverse of the matrix. If not square, abort.
 *  See notes re: Cholesky decomposition and use of LU for certain cases, 
 *  the problem is solved by http://wiki.cs.princeton.edu/index.php/TNT
 *  (Written on 05_Jul_04) (corrected on 06_May_28)
 */
